...
place("target", "cube", (0., 0., 0.), material= "Blade15Front", size_x = 10. * mm, size_y = 10. * mm, size_z = 100. * um)
...
set_run_name("BonnPIXE2_Blade15_Front")
config_run(3e11, 10) #Wenn Anwesend dann simulation sonst Interaktiv aber keine Simulation.
start_run("./output_runfiles/Blade15_Front_4.run") #Hier Pfad rein und der Code macht eine Datei mit dem Output.
